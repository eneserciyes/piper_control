...
if __name__ == "__main__":
    ...
    while True:
        ...
        piper.JointMitCtrl(1, joint1_pos, 0, 0.0, 0.0, 0.0)
        time.sleep(0.0003)
        piper.JointMitCtrl(2, joint2_pos, 0, 0.0, 0.0, 0.0)
        time.sleep(0.0003)
        piper.JointMitCtrl(3, joint3_pos, 0, 0.0, 0.0, 0.0)
        time.sleep(0.0003)
        piper.JointMitCtrl(4, joint4_pos, 0, 0.0, 0.0, 0.0)
        time.sleep(0.0003)
        piper.JointMitCtrl(5, joint5_pos, 0, 0.0, 0.0, 0.0)
        time.sleep(0.0003)
        piper.JointMitCtrl(6, joint6_pos, 0, 0.0, 0.0, 0.0)
        time.sleep(0.005)
